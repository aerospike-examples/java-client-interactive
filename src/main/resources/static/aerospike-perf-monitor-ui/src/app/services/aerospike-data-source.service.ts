...
import { AerospikeNode } from '../model/aerospike-node.model';
...
export class AerospikeDataSourceService {
  baseUrl : string;
  testEnv = true;
  ...
  getServerNodes() :Observable<AerospikeNode[]> {
    return this.http.get<AerospikeNode[]>(this.baseUrl + "api/ybserverinfo/");
  }
